...
namespace CateringService.Persistence.Migrations
{
    ...
    [Migration("20250617153830_AddUserAndRefreshTokenToDataBasse")]
    partial class AddUserAndRefreshTokenToDataBasse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CateringService.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)")
            ...
            modelBuilder.Entity("CateringService.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("CateringService.Domain.Entities.User", "User")
